$(document).ready(function () {
  ...
  var typed = new Typed(".typing-2", {
    strings: ["Desenvolvedor de Software,", "estudande de Análise e Desenvolvimento de Sistemas,", "formado em Gestão de Telecomunicações pelo INATEL,", "de Santa Rita do Sapucaí - MG,"],
    typeSpeed: 20,
    backSpeed: 80,
    loop: true
  });
